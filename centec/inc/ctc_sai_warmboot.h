...
#define SYS_WB_VERSION_MONITOR            CTC_WB_VERSION(1,0)
#define SYS_WB_VERSION_SYNCE              CTC_WB_VERSION(1,0)
...
typedef enum ctc_sai_wb_user_def_sub_type_e
{
    ...
    CTC_SAI_WB_USER_DEF_SUB_TYPE_ACL_BIND_POINT_TABLE,
    CTC_SAI_WB_USER_DEF_SUB_TYPE_ACL_BIND_POINT_GROUP,
    ...
    CTC_SAI_WB_USER_DEF_SUB_TYPE_ACL_RANGE,
    CTC_SAI_WB_USER_DEF_SUB_TYPE_ACL_COUNTER,
    CTC_SAI_WB_USER_DEF_SUB_TYPE_BFD_GLOBAL,
    CTC_SAI_WB_USER_DEF_SUB_TYPE_NPM_GLOBAL,
    CTC_SAI_WB_USER_DEF_SUB_TYPE_TWAMP_GLOBAL,
    CTC_SAI_WB_USER_DEF_SUB_TYPE_Y1731,
    CTC_SAI_WB_USER_DEF_SUB_TYPE_UDF_GROUP_MEMBER,
    CTC_SAI_WB_USER_DEF_SUB_TYPE_UDF_GROUP_HASH,
    CTC_SAI_WB_USER_DEF_SUB_TYPE_PORT,
    CTC_SAI_WB_USER_DEF_SUB_TYPE_SCHEDULER_GROUP_CHILD_LIST,
    CTC_SAI_WB_USER_DEF_SUB_TYPE_POLICER_PORT_LIST,
